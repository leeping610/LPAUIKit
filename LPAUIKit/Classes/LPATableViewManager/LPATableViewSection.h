...
FOUNDATION_EXTERN CGFloat const LPATableViewSectionHeaderHeightAutomatic;
FOUNDATION_EXTERN CGFloat const LPATableViewSectionFooterHeightAutomatic;

@class LPATableViewManager, LPATableViewCellStyle;

@interface LPATableViewSection : NSObject
 ...
 */
@property (nonatomic, weak) LPATableViewManager *tableViewManager;
 ...
 */
@property (nonatomic, strong) LPATableViewCellStyle *style;
